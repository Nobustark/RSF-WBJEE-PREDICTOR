  ...
  return (
    <div className="flex flex-col w-full relative z-10">
      ...
      <section className="w-full min-h-[600px] flex flex-col md:flex-row border-b-8 border-on-secondary-fixed border-8 border-on-surface">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-16 flex flex-col justify-center border-b-8 md:border-b-0 md:border-r-8 border-on-surface relative overflow-hidden bg-surface-variant">
      ...
      <section className="w-full py-20 px-4 md:px-16 bg-surface-bright relative border-l-8 border-r-8 border-on-surface border-b-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 relative z-10">
          ...
          {/* Step 1 */}
          <div className="md:col-span-5 bg-surface border-4 border-on-surface p-4 md:p-8 brutalist-shadow relative transform md:-translate-y-8">
          ...
          {/* Step 2 */}
          <div className="md:col-span-5 bg-on-surface text-on-primary p-4 md:p-8 relative transform md:translate-y-12" style={{ boxShadow: '8px 8px 0px 0px #d80000' }}>
          ...
          {/* Step 3 */}
          <div className="md:col-span-7 bg-primary-container text-on-primary border-4 border-on-surface p-4 md:p-8 brutalist-shadow relative mt-8 md:mt-24">
